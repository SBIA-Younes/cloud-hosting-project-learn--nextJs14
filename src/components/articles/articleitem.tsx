...
interface ArticleItemPropos {
  article: Article;
}
function ArticleItem({ article }: ArticleItemPropos) {
  return (
    <div
      key={article.id}
      className="p-5 rounded-lg m-1 shadow-lg border-2 border-gray-400 hover:bg-slate-200 w-full md:w-2/5 lg:w-1/4"
    >
