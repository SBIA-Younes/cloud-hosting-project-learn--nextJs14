      ...
      <section className='container m-auto px-5 animate-pulse'>
          ...
          <div  className="flex items-center justify-center flex-wrap gap-7">
            {articlesSkeleton.map((item) => (
              <div key={item}
              className="p-5 rounded-lg m-1 bg-gray-200 w-full md:w-2/5 lg:w-1/4">
              <h3 className="text-gray-300 h-6"></h3>
              <p className="my-2 h-10 bg-gray-300 p-1 "></p>
              <div
                className=" w-full block h-8 p-1 bg-gray-400 rounded-lg">
              </div>
            </div>
            ))}
          </div>
